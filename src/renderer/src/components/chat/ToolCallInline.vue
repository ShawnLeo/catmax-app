<template>
  ...
  <button
    type="button"
    class="flex items-center gap-2 py-1 text-[12px] hover:text-primary transition-colors"
  ...
  >
    ...
    <span class="text-muted-foreground font-mono truncate min-w-0">{{ fileName }}</span>
  </button>
</template>
